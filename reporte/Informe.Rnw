...
<<label=energias,echo=false,results=hide,fig=false>>==
      ...
      for(i in 1:length(docsLista) )
        ...
        x<-readLines(paste("C:/Users/icm25b/Documents/Javier/Pruebas R/analisisEnergia/Docs Vasp/Medea Machine/",docsLista[i],"/OUTCAR.out",sep = ""));
